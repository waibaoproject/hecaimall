...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FoundationExtension/FoundationExtension.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GearNetwork/GearNetwork.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/IQKeyboardManagerSwift/IQKeyboardManagerSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ImageViewer/ImageViewer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/InfiniteScrollingView/InfiniteScrollingView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Kingfisher/Kingfisher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PageViewController/PageViewController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PullRefresh/PullRefresh.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SegmentedControl/SegmentedControl.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WebImage/WebImage.framework"
fi
