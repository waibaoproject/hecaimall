...
#define UMSocial_Left_Space 0 //透明边的宽度
#define UMSocial_Page_Space 0//页面间距
#define UMSocial_Menu_Bottom_Space 0 //取消按钮距底部的距离
...
- (void)resetSelfFrame
{
    ...
    //设置偏移
    selfFrame.origin.y = superView.frame.size.height;
